...
"}"));
        ...
        activeprofile->setObjectName(QString::fromUtf8("activeprofile"));
        activeprofile->setGeometry(QRect(130, 20, 111, 111));
        activeprofile->setStyleSheet(QString::fromUtf8(""));
        activeprofile->setPixmap(QPixmap(QString::fromUtf8(":/new/prefix1/graphics/friend.png")));
        activeprofile->setScaledContents(true);
        change_photo = new QPushButton(frame);
        change_photo->setObjectName(QString::fromUtf8("change_photo"));
        change_photo->setGeometry(QRect(130, 140, 111, 31));
        change_photo->setStyleSheet(QString::fromUtf8("QPushButton \n"
"{\n"
"border-radius: 12px;\n"
"background: #26a8ff;\n"
...
""));
        ...
        passworde->setObjectName(QString::fromUtf8("passworde"));
    ...
    void retranslateUi(QMainWindow *signupform)
    {
        ...
        change_photo->setText(QCoreApplication::translate("signupform", "change photo", nullptr));
